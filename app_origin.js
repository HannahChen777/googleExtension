function display(){
    document.getElementById("people").onclick = function(){ getData() };
}

function getData(){
    const headers = {
        'Authorization':'ematic-apikey=8e95da3ce0ff11eab50e0242ac110002-sg7,esp-apikey=93a16d76f9c340a6589c1858df44aec6,ematic-admin-apikey=874fad42bec611e99aad0242ac110002-us1',
